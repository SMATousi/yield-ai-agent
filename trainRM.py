...
Usage:
    python trainRM.py
    python trainRM.py --n-layers 3 --hidden-size 256 --n-epochs 200
"""
import argparse
import json
import os
...
def main() -> None:
    ...
    print("Training...")
    best_val_rmse, history = train_model_rm(
    ...
    test_rmse = run_epoch_rm(model, test_loader, None, criterion, device, train=False)
